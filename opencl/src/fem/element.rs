...
impl Element {
    pub fn new(
        ...
        let f_eclipse =
            Self::calculate_f_eclipse_multiple_earth(area, &properties, &factors, generated_heat);
    ...
    fn calculate_f_eclipse_multiple_earth(
        ...
        for earth_value in earth {
            let f = Self::calculate_f_eclipse(area, &properties, generated_heat, *earth_value);
    ...
    fn calculate_f(
        ...
        let ir = properties.alpha_ir * constant * earth_view_factor;
