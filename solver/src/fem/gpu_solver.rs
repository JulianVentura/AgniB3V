...
impl GPUSolver {
    ...
    /// Arguments:
    ///
    /// * `src_path`: The `src_path` parameter is a string that represents the path to the OpenCL kernel
    /// code file. This file contains the code that will be executed on the OpenCL device.
    ///
    /// Returns:
    ///
