...
def test_parse_eclipse_locator_file():
    parameters = gmat_parser.parse_report_file(GMAT_REPORT_FILE_PATH)
    eclipse_start_and_finish, period = gmat_parser.parse_eclipse_locator(
        GMAT_ECLIPSE_LOCATOR_FILE_PATH, parameters
    )
...
def test_parse_no_eclipse_locator_file():
    parameters = gmat_parser.parse_report_file(GMAT_REPORT_FILE_PATH)
    eclipse_start_and_finish, period = gmat_parser.parse_eclipse_locator(
        GMAT_ECLIPSE_LOCATOR_FILE_PATH_NO_ECLIPSE, parameters
    )
