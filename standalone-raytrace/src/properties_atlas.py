...
class PropertiesAtlas():
    ...
    def __init__(self, elements_amount, props_file_path, orbit_report_file_path=None, orbit_eclipse_file_path=None):
        """
        ...
        with open(props_file_path) as material_file:
            ...
            if (orbit_report_file_path and orbit_eclipse_file_path):
               self.orbit_properties = gmat_parser.parse_gmat(orbit_report_file_path, orbit_eclipse_file_path)
            else:
